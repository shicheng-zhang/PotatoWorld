...
void render_init () {
    ...
    glUniform3f (instanced_uniforms.light_position_location, 100.0f, 200.0f, 50.0f);
    ...
    block_render_world (&pw_world, projection_matrix_flat_array, view_matrix_flat_array,
