...
void main () {
    ...
    float specular_lighting_intensity_coefficient = 0.3f;
    ...
    float specular_exponent_factor = pow (max (dot (camera_to_fragment_view_direction_vector, light_reflection_direction_vector), 0.0f), 16.0f);
